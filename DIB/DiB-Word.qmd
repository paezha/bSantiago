...
skim_SRPD$factor.top_counts[16] <- skim_SRPD$factor.top_counts[16] |>
  str_replace_all(c(VER = "NOT IMPORTANT",
                    ABO = "IMPORTANT",
                    AVE = "MODERATELY IMPORTANT",
                    BEL = "SLIGHTLY IMPORTANT"))
...
skim_SSI$factor.top_counts[3] <- skim_SSI$factor.top_counts[3] |>
  str_replace_all(c(POO = "POOR",
                    FAI = "FAIR",
                    GOO = "GOOD", 
                    VER = "VERY GOOD"))
...
skim_SSI$factor.top_counts[6] <- skim_SSI$factor.top_counts[6] |>
  str_replace_all(c(5-1 = "5-15%",
                    15 = "15-30%",
                    30 = "30% or more")) 
                  
skim_SSI$factor.top_counts[7] <- skim_SSI$factor.top_counts[7] |>
  str_replace_all(c(VER = "VERY IMPORTANT",
                    IMP = "IMPORTANT",
                    MOD = "MODERATELY IMPORTANT",
                    NOT = "NOT IMPORTANT"))

skim_SSI$factor.top_counts[8] <- skim_SSI$factor.top_counts[8] |>
  str_replace_all(c(VER = "VERY IMPORTANT",
                    IMP = "IMPORTANT",
                    MOD = "MODERATELY IMPORTANT",
                    SLI = "SLIGHTLY IMPORTANT"))

skim_SSI$factor.top_counts[9] <- skim_SSI$factor.top_counts[9] |>
  str_replace_all(c(VER = "VERY IMPORTANT",
                    IMP = "IMPORTANT",
                    MOD = "MODERATELY IMPORTANT",
                    SLI = "SLIGHTLY IMPORTANT"))

skim_SSI$factor.top_counts[10] <- skim_SSI$factor.top_counts[10] |>
  str_replace_all(c(VER = "VERY IMPORTANT",
                    IMP = "IMPORTANT",
                    MOD = "MODERATELY IMPORTANT",
                    SLI = "SLIGHTLY IMPORTANT"))
