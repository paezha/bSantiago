...
#' A data frame with information about whole survey and geographic features of respondents to the survey
#'
#' A dataset containing information about whole survey and geographic features of users of active and motorized modes of transportation in
#' Santiago sourced from 2016 survey.
#'
#'  @format A data frame with 396 rows and 142 variables:
#' \describe{
#' \item{ID}{Unique identifier of respondent}
#'   \item{r0A_COMMUNE}{Commune of residence}
#'   \item{r0B_MACR_ZONE}{Macro area of residence}
...
#'   \item{r8F_SCHEDULE}{What is the frequent time of their commuting?; this variable is an ordered factor with six levels, "7:00 - 9:00", "9:00 - 13:00", "13:00 - 15:00", "15:00 - 18:00", "18:00 - 21:00", "Others"}
#'   \item{r8G_SPENDING}{Monthly expenditure on transport; this variable is an ordered factor with four levels, "Less than 35.000", "35.000-75.000", "75.000-125.000", "More than 125.000"}
#'   \item{COMUNA}{Communes where respondents live}
#'   \item{REGION}{Regions where respondents live}
#'   \item{HA}{Height of the places where respondents live}
#'   \item{LAYER}{Cities or communes of respondents to the survey}
#'   \item{COORD_X}{X axis of the location of respondents in cartesian coordinate system}
#'   \item{COORD_Y}{Y axis of the location of respondents in cartesian coordinate system}
#'   \item{Shape_Leng}{Length of the polygones}
#'   \item{Shape_Area}{Area of the polygones}
#'
#' @docType data
#' @keywords datasets
#' @name San_comuna2
#' @usage data(San_comuna2)
#' @source A face to face survey considering pre-census 2012
#' @examples
#'  data(San_comuna2)
#'  COMUNA <- San_comuna2$COMUNA
"San_comuna2"
