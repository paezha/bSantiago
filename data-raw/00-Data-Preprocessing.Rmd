...
setwd("C:/Users/nalaeen/Desktop/bSantiago/data-raw/comunas_1")

# list files:
list.files(path=".")

comunas_1 <- read_sf('C:/Users/nalaeen/Desktop/bSantiago/data-raw/comunas_1')
summary(comunas_1)
plot(comunas_1)
...
A <- A %>%
  left_join(comunas_1,
              #select(COMUNA) %>%
              #st_drop_geometry(),
            by = c("r0A_COMUNA"="COMUNA"))
```

```{r}
write.csv(comunas_1, file = 'C:/Users/nalaeen/Desktop/bSantiago/data-raw/comunas_1/comunas_1.csv')
```
...
comunas_1 <- st_read("C:/Users/nalaeen/Desktop/bSantiago/data-raw/comunas_1/comunas_1Polygon.shp")
```
...
library(stringr)
str_split_fixed(SantiagoSurvey2016$r2AA_LIBERTAD, "", 8)%>%
 datatable(., rownames = FALSE, options = list(scrollX = TRUE))
...
of r0C_GENDER, r0J_INCOME, r0D_AGE, and r0P_MODE1 r1A_STRESS and r1GA_IMPSTRESS
...
<!-- # We are going to evaluate the data for factor analysis in order to find highest correlation between predictors to put into the model -->
...
<!--                              levels = c("Less18", "18to24", "25to34", "35to54","55to64", "65more"),  -->
...
<!--                              levels = c("ELEMENTARY", "SECUNDARY", "PROFESS_TECH", "COLLEGE", "POSTGRAD"),  -->
...
<!--                              levels = c("FULL_TIME", "PART_TIME", "SELF_EMPLOYED", "UNEMPLOYED", "HOME_TAKER","STUDENT", "STUDENT_WORK", "RETIRED", "OTHER"),  -->

<!--                              labels = c("1", "2", "3", "4", "5","6", "7", "8", "9"))) %>%   -->

<!--   mutate(r0J_INCOME = factor(r0J_INCOME,  -->

<!--                              levels = c("Less423", "423to639", "639to977", "977to1550", "1550to2380","2380more"),  -->
...
<!--                              levels = c("CAR", "TAXI", "COLECTIVO", "MOTO", "METRO", "BUS","BICYCLE", "WALK"),  -->
...
<!--                              levels = c("VHIGH", "HIGH", "MEDIUM", "LOW", "VLOW"),  -->
...
<!--                              levels = c("VNEGATIVE", "NEGATIVE", "NEUTRAL", "POSITIVE", "VPOSITVE"),  -->
...
<!--                              levels = c("VDISSATISFIED", "DISSATISFIED", "UNSURE", "SATISFIED", "VSATISFIED"),  -->
...
<!--                              levels = c("NOT IMPORTANT", "SLIGHTLY IMPORTANT", "MODERATELY IMPORTANT", "IMPORTANT", "VERY IMPORTANT"),  -->
...
<!-- df3 <- subset(df2, select = -c(r0B_MACR_ZONE, r0I_WORK_COM_1, r0I_WORK_COM_2, r0A_COMMUNE, r0B_MACR_ZONE, r0B_STREET_1, r0B_STREET_2, r0O_TYPE_DIS)) |> -->
...
<!-- df4 <- df3[, KMO(df3)$MSAi>0.50] # Get rid of all variables with MSA < 0.50 -->

<!-- ``` -->

<!-- ```{r} -->

<!-- # Now we are going to check if inappropriate variables have been removed or not -->
...
<!-- ##In this test we are going to rule out that the variables in the data set are essentially uncorrelated -->

<!-- cortest.bartlett(df4) -->
...
<!-- ev <- eigen(cor(df5)) # get eigenvalues -->
...
<!-- scree(df5, pc=FALSE)  # Use pc=FALSE for factor analysis -->

<!-- ``` -->

<!-- ## We can also check parallel analysis -->

<!-- ```{r} -->

<!-- fa.parallel(df5, fa="fa") -->
...
mutate(r0H_OCCUPATION = recode_factor(r0H_OCCUPATION,
   ...
   df$r0H_OCCUPATION <- relevel(df$r0H_OCCUPATION, ref = "UNEMPLOYED")
