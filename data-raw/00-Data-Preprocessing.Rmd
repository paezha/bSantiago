...
multi_vars <- grep("r2AA_LIBERTAD", SantiagoSurvey2016, value = TRUE) 
              grep("r2AB_INSEG" , SantiagoSurvey2016, value = TRUE)
              grep("r2AC_FUNCIONA" ,SantiagoSurvey2016, value = TRUE)
              
# multi_vars <- grep("^r2AB_INSEG", colnames(SantiagoSurvey2016), value = TRUE)
# multi_vars <- grep("^r2AC_FUNCIONA", colnames(SantiagoSurvey2016), value = TRUE)
