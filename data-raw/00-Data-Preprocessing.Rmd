...
Santiago_H <- SantiagoSurvey_trans %>%
  ...
  mutate(r1A_STRESS = factor(r1A_STRESS, 
                             levels = c("1", "2", "3", "4", "5"), 
                             labels = c("VERY HIGH", "ABOVE AVERAGE", "AVERAGE", "BELOW AVERAGE", "Too LOW"),
                             ordered = TRUE)) %>%
  ...
  mutate(r1D_CONTAM = factor(r1D_CONTAM, 
                             levels = c("1", "2", "3", "4", "5"), 
                             labels = c("Too DISSATISFIED", "DISSATISFIED", "UNSURE", "SATISFIED", "VEERY SATISFIED"),
                             ordered = TRUE)) %>%
...
Santiago_RPD <- SantiagoSurvey_trans %>%
 ...
 mutate(r3DA_FAM = factor(r3DA_FAM, 
  ...
  mutate(r3G_QUALITY_INCRS = factor(r3G_QUALITY_INCRS, 
                             levels = c("1", "2", "3", "4", "5"), 
                             labels = c("TOO LOW", "BELOW AVERAGE", "AVERAGE", "ABOVE AVERAGE", "VERY HIGH"),
                             ordered = TRUE)) %>%
